...
public class P11_largest_product_in_a_grid {
	...
	static Integer[][] grid = {{8, 2, 22, 97, 38, 15, 0, 40, 0, 75, 4, 5, 7, 78, 52, 12, 50, 77, 91, 8},
		...
		for (int i = 0; i < 20; i++){
			for (int j = 0; j < 20; j++){
				...
				if (i < 20 && j+3 < 20){
					...
					if (product > maxProduct){
						maxProduct = product;
						System.out.println("[(" + i + "," + j + "),(" + (i) + "," + (j+1) + "),(" + (i) + "," + (j+2) + "),(" + (i) + "," + (j+3) + ")]");
				...
				if (i+3 < 20 && j < 20){
					...
					if (product > maxProduct){
						maxProduct = product;
						System.out.println("[(" + i + "," + j + "),(" + (i+1) + "," + (j) + "),(" + (i+2) + "," + (j) + "),(" + (i+3) + "," + (j) + ")]");
